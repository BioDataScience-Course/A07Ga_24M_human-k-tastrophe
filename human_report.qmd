...
>>>>>>> 0ccd4066fa5658cdb5022bd9762335f641d18798
biometry1 <- biometry %>%
  drop_na()
...
chart(data = biometry_imc[!is.na(biometry_imc$age_rec), ], IMC ~ age_rec |genre) +
  geom_boxplot() +
