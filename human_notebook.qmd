...
```{r}
chart(data = biometry, taille ~ genre %fill=% genre |alimentation )+
  geom_boxplot()
```
...
```{r}
chart(data = biometry, ~ alcool %fill=% genre|genre) + 
  geom_histogram(bins = 20) + 
  labs(title = "Consommation d'alcool en fonction du genre", y = "Effectif", x = "Consommation d'alcool [verre/sem]", col = "Genre")
```
